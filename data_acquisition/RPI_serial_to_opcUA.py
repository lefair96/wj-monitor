...
if __name__ == "__main__":
    # setup our server
    server = Server()
    server.set_endpoint("opc.tcp://192.168.1.8:4840/freeopcua/server/")
    ...
    temperature = wjMonitor.add_variable(
        idx, "temperature", ua.Variant(0, ua.VariantType.Double))

    pressure = wjMonitor.add_variable(idx, "pressure", ua.Variant(
        0, ua.VariantType.Double))
    # starting!
    server.start()
    try:
        count = 0
